...
const qualificationPattern =
  /具备([^，。；\s]+(?:施工总承包|专业承包))([特一二三壹贰叁123]级|不分等级)(?:及以上|或以上)?资质/g;
...
const personnelPatterns = [
  /项目负责人(?:须)?具备([^，。；\s]+?)(?:专业)?([特一二三壹贰叁123]级|不分等级)(?:及以上|或以上)?(?:注册)?建造师/g,
  /拟派项目负责人(?:须)?具备([^，。；\s]+?)(?:专业)?([特一二三壹贰叁123]级|不分等级)(?:及以上|或以上)?(?:注册)?建造师/g,
  /项目负责人(?:具有|持有)([^，。；\s]+?)(?:专业)?([特一二三壹贰叁123]级|不分等级)(?:及以上|或以上)?(?:注册)?建造师(?:执业资格)?/g
];
